...
function MainInformation() {
  ...
  function fRusValues() {
    let engLangSwitchButton = document.getElementById("eng-button");
    let rusLangSwitchButton = document.getElementById("rus-button");
    ...
    let correctRepeats = document.getElementById("correct-repeats");
